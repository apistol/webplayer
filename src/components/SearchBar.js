    ...
    return (
        <div className='flex justify-between w-full'>
            <div className='flex items-center '>
                ...
                {isDesktop && <span className='block p-2 rounded-full bg-gray'><BsChevronLeft color="#FFF" size={24} /></span>}
                {isDesktop && <span className='block p-2 ml-5 rounded-full bg-gray'><BsChevronRight color="#FFF" size={24} /></span>}
            </div>
